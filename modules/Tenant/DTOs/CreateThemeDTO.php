...
class CreateThemeDTO extends ValidatedDTO
{
    public string $title;
    ...
    protected function rules(): array
    {
        return [
            ...
            'primary_color_light' => ['required', 'regex:/^#([a-f0-9]{6}|[a-f0-9]{3})$/i'],
            'secondary_color_light' => ['required', 'regex:/^#([a-f0-9]{6}|[a-f0-9]{3})$/i'],
            'primary_color_dark' => ['required', 'regex:/^#([a-f0-9]{6}|[a-f0-9]{3})$/i'],
            'secondary_color_dark' => ['required', 'regex:/^#([a-f0-9]{6}|[a-f0-9]{3})$/i'],
