...
use Modules\Tenant\Events\CreatedBucket;
use Modules\Tenant\Events\CreatingBucket;
use Modules\Tenant\Events\DeletedBucket;
use Modules\Tenant\Events\DeletingBucket;
...
class Bucket
{
    ...
    public function getErrorBag(): ?AwsException
    {
